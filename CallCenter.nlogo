globals [
  ...
  normal-satisfaction-list
  vip-satisfaction-list
...
to setup
  ...
  set normal-satisfaction-list []
  set vip-satisfaction-list []
...
to create-client
  create-clients 1 [
    ...
    [if willing-to-wait < length vip-cur-waiting-queue [
